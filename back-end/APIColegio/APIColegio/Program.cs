...
## Funcionalidades
- ✅ **Crear alumnos** con informacion completa
- ✅ **Consultar alumnos** por ID, grado o todos
- ✅ **Validaciones de negocio** automaticas
...
using (var scope = app.Services.CreateScope())
{
    ...
    for (int i = 0; i < maxRetries; i++)
    {
        try
        {
            ...
            Console.WriteLine($"🔄 Intento {i + 1}/{maxRetries} - Verificando conexion a la base de datos...");
            
            // Verificar si se puede conectar
            await context.Database.CanConnectAsync();
            Console.WriteLine("✅ Conexion a PostgreSQL exitosa");
        ...
        {
            Console.WriteLine($"❌ Intento {i + 1} fallo: {ex.Message}");
...
Console.WriteLine();
Console.WriteLine("📋 Acceso rapido:");
